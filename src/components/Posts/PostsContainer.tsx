...
import { getPostsUrl } from 'common/path';
  ...
  const { data: list, isLoading } = useIQuery<Array<Post> | undefined>(
    ...
    () =>
      true
        ? [
            ...
            },
            {
              ...
              tags: [
                ...
                { id: 'tag2', name: 'fghg', color: '#6445F3' },
                { id: 'tag3', name: 'asdasd', color: '#234264' },
                { id: 'tag4', name: 'asdasd', color: '#234264' },
                { id: 'tag5', name: 'asdasd', color: '#234264' },
                { id: 'tag6', name: 'asdasd', color: '#234264' },
                { id: 'tag7', name: 'asdasd', color: '#234264' },
                { id: 'tag8', name: 'asdasd', color: '#234264' },
                { id: 'tag9', name: 'asdasd', color: '#234264' },
              ],
        ...
        : fetchApi<Array<Post>>(getPostsUrl(filters.map((filter) => filter.id)), getGetConfig()),
